...
<body class="usuarios">	
	...
	</form> <form method="post" name="Crear" id="button">
		<input type="submit" name="Crear" value="Crear">
	</form> <form method="post" name="Actualizar" id="button">
		<input type="submit" name="Actualizar" value="Actualizar">
	</form> <form method="post" name="Borrar" id="button">
